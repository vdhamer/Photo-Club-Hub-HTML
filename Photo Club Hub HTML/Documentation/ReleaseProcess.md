...
| Archive gate | `scripts/gate-and-stamp.sh`, byte-identical to the iOS copy — including the `b<number>` check. A [weekly sweep](https://github.com/vdhamer/Photo-Club-Hub-Data/blob/main/.github/workflows/weekly-sweep.yml) in Photo-Club-Hub-Data fails when the two get out of sync |
