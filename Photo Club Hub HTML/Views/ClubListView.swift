        ...
        .toolbar {
            ToolbarItemGroup(placement: .primaryAction) {
                ...
                Menu {
                    ...
                    SingleExpertiseTest { expertiseID, language in
...
private struct SingleExpertiseTest: View { // temporary, will be replaced by a ForEach loop
    let generatePage: (String, String) -> Void // fancy solution generated by Claude Code

    var body: some View {
        let expertise = String(localized: "expertise",
                               table: "PhotoClubHubHTML.SwiftUI",
                               comment: "Word 'expertise' used in temporary test button labels")
        Button(String("L0: nl/Architecture \(expertise)")) { generatePage("Architecture", "nl") }
        Button(String("L0: nl/Drone \(expertise)")) { generatePage("Drone", "nl") }
        Button(String("L0: nl/City \(expertise)")) { generatePage("City", "nl") }
        Button(String("L0: en/Architecture \(expertise)")) { generatePage("Architecture", "en") }
        Button(String("L0: en/Drone \(expertise)")) { generatePage("Drone", "en") }
        Button(String("L0: en/City \(expertise)")) { generatePage("City", "en") }
    }
}
